...
Aguardo contato para agendamento. Obrigado!`;
  ...
  return <section id="inicio" className="relative overflow-hidden bg-gradient-primary text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button size="lg" variant="secondary" className="text-primary font-semibold" onClick={handlePhoneClick}>
                <Phone className="mr-2" size={20} />
                (11) 96642-4414
              </Button>
              <Button size="lg" variant="outline" onClick={handleWhatsAppClick} className="border-white bg-lime-600 hover:bg-lime-500 text-slate-50">
          ...
          <div className="animate-fade-in-up lg:justify-self-end">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <form className="space-y-4" onSubmit={handleFormSubmit}>
                <input type="text" name="nome" placeholder="Seu nome" required className="w-full px-4 py-3 rounded-lg bg-white/90 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400" />
                <input type="tel" name="telefone" placeholder="Seu telefone" required className="w-full px-4 py-3 rounded-lg bg-white/90 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400" />
                <select name="equipamento" required className="w-full px-4 py-3 rounded-lg bg-white/90 text-gray-800 focus:outline-none focus:ring-2 focus:ring-yellow-400">
                ...
                <input type="text" name="problema" placeholder="Qual o problema? (ex: não liga, faz barulho)" required className="w-full px-4 py-3 rounded-lg bg-white/90 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400" />
